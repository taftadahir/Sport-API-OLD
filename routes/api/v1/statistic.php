...
use App\Http\Controllers\api\v1\statistic\DeleteStatisticController;
...
Route::delete('statistics/{statistic}', DeleteStatisticController::class)
    ->name('workouts.statistic.destroy');
